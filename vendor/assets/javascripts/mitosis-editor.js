...
var MitosisEditor = (() => {
  ...
  var EditorPane = class {
    ...
    handleKeyDown(e) {
      ...
      for (const shortcut of SHORTCUTS) {
        if (e.key === shortcut.key && (e.metaKey || e.ctrlKey) && e.shiftKey === (shortcut.shiftKey ?? false)) {
          e.preventDefault();
  ...
  // node_modules/.pnpm/marked@17.0.2/node_modules/marked/lib/marked.esm.js
  function M() {
...
Please report this to https://github.com/markedjs/marked.`, e) {
  ...
  // node_modules/.pnpm/marked-highlight@2.2.3_marked@17.0.2/node_modules/marked-highlight/src/index.js
  ...
  function parseMarkdownToHTML(markdown, prism) {
    if (!markdown.trim())
      return "";
    if (prism) {
      configureHighlightExtension(prism);
    }
    const result = g(markdown);
  ...
  // dist/view/two-panel-layout.js
  var TwoPanelLayout = class {
    container;
    editorPaneContainer;
    ...
    handleDrag(e) {
      ...
      const percentage = x2 / containerRect.width * 100;
